...
int main() {
    ...
    do {
        cout << "\n=== FILA/DEQUE CON LIBRERIA STL (string) ===" << endl;
        ...
        switch (opcion) {
            case 1: cout << "Texto: "; cin >> valor; fila.insertarFrente(valor); break;
            case 2: cout << "Texto: "; cin >> valor; fila.insertarFinal(valor); break;
            case 3:
