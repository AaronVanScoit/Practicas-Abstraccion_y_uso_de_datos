...
int main(){
    ...
    for(int i=0;i<7;i++) g.enqueueNodo(lugares[i]);
    g.matAdj[0][1]=10;g.matAdj[1][0]=10;g.matAdj[1][2]=8;g.matAdj[2][1]=8;
    g.matAdj[2][3]=12;g.matAdj[3][2]=12;g.matAdj[3][4]=7;g.matAdj[4][3]=7;
    g.matAdj[4][5]=5;g.matAdj[5][4]=5;g.matAdj[5][6]=8;g.matAdj[6][5]=8;
    ...
    do{
        ...
        case 3:{Lugar l;cout<<"ID: ";cin>>l.id;cout<<"Etiqueta: ";cin>>l.etiqueta;g.enqueueNodo(l);}break;
        case 4:{Lugar l=g.dequeueNodo();if(l.id!=-1)cout<<"Dequeue: "<<l.etiqueta<<endl;}break;
