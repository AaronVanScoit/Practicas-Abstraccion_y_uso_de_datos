...
int main(){
    ...
    for(int i=0;i<7;i++) g.pushNodo(lugares[i]);
    ...
    do{
        ...
        case 3:{Lugar l;cout<<"ID: ";cin>>l.id;cout<<"Etiqueta: ";cin>>l.etiqueta;g.pushNodo(l);}break;
        case 4:{Lugar l=g.popNodo();if(l.id!=-1)cout<<"Pop: "<<l.etiqueta<<endl;}break;
