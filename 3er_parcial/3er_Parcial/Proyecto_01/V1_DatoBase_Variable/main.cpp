...
int main(){
    ...
    do{
        cout<<"\n=== GRAFO V1: DatoBase int variable ===\n1.Mostrar\n2.Dijkstra\n3.Cargar XML\n4.Cargar JSON\n5.Guardar\n0.Salir\nOpcion: ";cin>>op;
        switch(op){
            case 1: g.mostrar(); break;
            case 2:{int o;cout<<"Origen: ";cin>>o;g.dijkstra(o);}break;
            case 3:{string f;cout<<"Archivo: ";cin>>f;g.cargar(f,"xml");}break;
            case 4:{string f;cout<<"Archivo: ";cin>>f;g.cargar(f,"json");}break;
